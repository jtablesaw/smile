...
import tech.tablesaw.api.ml.classification.Knn;
...
public class KnnExample extends Example {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Knn knn = Knn.learn(2, train.numberColumn(2), train.nCol("X"), train.nCol("Y"));

        ConfusionMatrix matrix = knn.predictMatrix(test.numberColumn(2), test.nCol("X"), test.nCol("Y"));
