...
public class FrequentItemsetExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        out(table.structure());
        out(table.shape());
        NumberColumn movie = table.numberColumn("movie");
        StringColumn moviecat = StringColumn.create("MovieCat");
        ...
        FrequentItemset model = new FrequentItemset(table.numberColumn("user"), table.stringColumn("MovieCat"), .24);
