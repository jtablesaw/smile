...
public class AssociationRuleMiningExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        AssociationRuleMining model = new AssociationRuleMining(table.numberColumn("user"), table.numberColumn("movie")
                , supportThreshold);

        FrequentItemset frequentItemsetModel = new FrequentItemset(table.numberColumn("user"), table.numberColumn
