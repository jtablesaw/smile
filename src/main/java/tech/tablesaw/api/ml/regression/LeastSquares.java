...
public class LeastSquares {
    ...
    public LeastSquares(NumberColumn responseVariable, NumberColumn... explanatoryVars) {
    ...
    public static LeastSquares train(NumberColumn responseVar, NumberColumn... explanatoryVars) {
